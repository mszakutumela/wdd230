...
const displayLinks(weeks) {
    // weeks.foreach((weeks) => { typeerror: weeks.foreach is not a function
    weeks.forEach((week) => {
        const list = document.querySelector(".left-card");
        const activities = document.createElement("li");
        const weekNumber = weeks.week;
        //W01
        const title1 = weeks.links[0].title;
        const url1 = weeks.links[0].url;
        //W02
        const title2 = weeks.links[1].title;
        const url2 = weeks.links[1].url;
        //W03
        const title3 = weeks.links[2].title;
        const url3 = weeks.links[2].url;
        //W04
        const title4 = weeks.links[3].title;
        const url4 = weeks.links[3].url;
