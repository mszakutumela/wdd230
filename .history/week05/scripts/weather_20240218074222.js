...
const url = "https://api.openweathermap.org/data/2.5/weather?lat=49.75&lon=6.64&unitis=imperial&appid=b9cc737521b8a6ba0b4048c7deb546c5";
...
function displayResults(data) {
    ...
    let degs    c = data.weather[0].description;
